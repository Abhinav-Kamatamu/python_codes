...
def minimax(position, depth, maximizingPlayer, alpha, beta):
    ...
    if maximizingPlayer:
            ...
            while j < len(position["board"][i]):
                ...
                if piece != "-" and checkTeam(piece):
                    ...
                    for move in moves:
                        ...
                        clone = copy.deepcopy(position)
                        playMove(clone, (j, i), move, False)

                        currentEvaluation = minimax(clone, depth - 1, False, alpha, beta)[0]
        ...
        return (maxEvaluation, maxPosition)     
            ...
            while j < len(position["board"][i]):
                ...
                if piece != "-" and not checkTeam(piece):
                    ...
                    for move in moves:
                        ...
                        currentEvaluation = minimax(clone, depth - 1, True, alpha, beta)[0]
        ...
        return (minEvaluation, minPosition)    
...
while not position["gameOver"]:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if currentPiece != "-" and checkTeam(currentPiece) == position["turn"] == True:
